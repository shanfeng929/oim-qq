...
function showFind() {
    document.getElementById("show_find_pane").style.display = "block";
    document.getElementById("find_text_input").style.background = "#21386e";
    document.getElementById("find_switch").src = "images/main/search/close.png";
}

function hideFind() {
    document.getElementById("show_find_pane").style.display = "none";
    document.getElementById("find_text_input").style.background = "#3c4a62";
    document.getElementById("find_switch").src = "images/main/search/empty.png";
}
...
function showFindResult() {
    ...
    var userList = ub.findUserDataList(text);
    var groupList = gb.findGroupList(text);

    var resultList = $("#find_result_list");
    var ul = userList.length;
    ...
    html = html + "    <div class=\"\">";
    html = html + "        <h4 class=\"contact_title first\">好友</h4>";
    html = html + "    </div>";
...
//        html = html + "</li>";
        ...
        html = html + "    <div  onclick=\"showUserInfo('" + userId + "');\" class=\"\">";
        html = html + "        <div class=\"\">";
        html = html + "            <div class=\"contact_item on\" >";
        html = html + "                <div class=\"avatar\">";
        html = html + "                    <img class=\"img\" src=\"" + head + "\" alt=\"\">";
        html = html + "                </div>";
        html = html + "                <div class=\"info\">";
        html = html + "                    <h4 class=\"nickname\" >" + showName + "</h4>";
        html = html + "                </div>";
        html = html + "            </div>";
        html = html + "        </div>";
        html = html + "    </div>";
    ...
    html = html + "    <div class=\"\">";
    html = html + "        <h4 class=\"contact_title\">群组</h4>";
    html = html + "    </div>";
    for (var i = 0; i < gl; i++) {
        ...
        var showName = moreFilter(name, 7);
...
//        html = html + "</li>";
        ...
        html = html + "    <div  onclick=\"showGroupInfo('" + groupId + "');\" class=\"\">";
        html = html + "        <div class=\"\">";
        html = html + "            <div class=\"contact_item on\" >";
        html = html + "                <div class=\"avatar\">";
        html = html + "                    <img class=\"img\" src=\"" + head + "\" alt=\"\">";
