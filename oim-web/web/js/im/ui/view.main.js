...
//            html = html + "</li>";
            ...
            html = html + "        <div id=\"" + id + "\" class=\"chat_item\">";
            html = html + "            <div  >";
            html = html + "                <div class=\"ext\">";
            html = html + "                    <p class=\"attr\">12:51</p>";
            html = html + "                </div>";
            html = html + "                <div class=\"avatar\">";
            html = html + "                    <img id=\"" + headId + "\" class=\"img " + css + "\" src=\"" + head + "\" alt=\"\">";
            html = html + "                    <i id=\"" + redId + "\" class=\"\" ></i>";
            html = html + "                </div>";

            html = html + "                <div class=\"info\">";
            html = html + "                    <h3 class=\"nickname\">";
            html = html + "                        <span id=\"" + nameId + "\" class=\"nickname_text\">" + name + "</span>";
            html = html + "                    </h3>";
            html = html + "                    <p class=\"msg\">";
            html = html + "                        <span id=\"" + textId + "\" class=\"\"></span>";
            html = html + "                    </p>";
            html = html + "                </div>";
    ...
    own.setItemRed = function (type, itemId, red) {
        ...
        if (redTag) {
            if (red) {//icon web_wechat_reddot_middle
...
//            }
            ...
            own.setItemRed  (type, itemId, false);
            // if (tempItemKey != itemKey) {
            //
            // }
            select(item);
...
//            html = html + "</li>";
            ...
            html = html + "        <div id=\"" + id + "\" class=\"\">";
            html = html + "                <div class=\"\">";
            html = html + "                    <div class=\"contact_item\" >";
            html = html + "                        <div class=\"avatar\">";
            html = html + "                            <img id=\"" + headId + "\" class=\"img " + css + "\" src=\"" + head + "\" alt=\"\">";
            html = html + "                        </div>";
            html = html + "                        <div class=\"info\">";
            html = html + "                            <h4 id=\"" + nameId + "\" class=\"nickname\" >" + name + "</h4>";
            html = html + "                        </div>";
            html = html + "    <span id=\"" + redId + "\" class=\"\"></span>";
            html = html + "                    </div>";
            html = html + "                </div>";
...
function UserInfoPaneView(paneId) {
    ...
    function getInfoPane(userData) {
        ...
        var genderTag = "";
        if (gender == '1') {
            genderTag = "<i class=\"web_wechat_men\"></i>";
        }
        if (gender == '2') {
            genderTag = "<i class=\"web_wechat_women\"></i>";
        }
        var editHtml = "";
...
//        html += "    </div>";
        ...
        html += "        <div class=\"box_hd with_border\">";
        html += "            <div class=\"title_wrap\">";
        html += "                <div class=\"title\">详细信息</div>";
        html += "            </div>";
        html += "        </div>";
        ...
        html += "                        <img class=\"img\" src=\"" + head + "\" alt=\"\">";
        html += "                    </div>";
        html += "                    <div class=\"nickname_area\">";
        html += "                        <h4 class=\"nickname\">" + (isEmpty(nickname) ? "" : nickname) + "</h4>";
        html += genderTag;
        // <!--<i class="web_wechat_women"></i>-->
        html += "                    </div>";
        html += "                    <p class=\"signature\" >" + (isEmpty(signature) ? "" : signature) + "</p>";
        html += "                    <div class=\"meta_area\">";
        html += "                        <div class=\"meta_item\">";
        html += "                            <label class=\"label\">备注：</label>";
        html += "                            <p class=\"value\" >" + (isEmpty(remarkName) ? "" : remarkName) + editHtml + "</p>";
        html += "                        </div>";
        html += "                        <div class=\"meta_item\">";
        html += "                            <label class=\"label\">账号：</label>";
        html += "                            <p class=\"value\">" + (isEmpty(account) ? "" : account) + "</p>";
        html += "                        </div>";
        html += "                        <div class=\"meta_item\">";
        html += "                            <label class=\"label\">手机：</label>";
        html += "                            <p class=\"value\">" + (isEmpty(mobile) ? "" : mobile) + "</p>";
        html += "                        </div>";
        html += "                        <div class=\"meta_item\">";
        html += "                            <label class=\"label\">Email：</label>";
        html += "                            <p class=\"value\">" + (isEmpty(email) ? "" : email) + "</p>";
        html += "                        </div>";
        html += "                    </div>";
        html += "                    <div class=\"action_area\">";
        html += "                        <a id=\"" + buttonId + "\" class=\"button\"  href=\"#\">发消息</a>";
        html += "                    </div>";
        html += "                </div>";
        html += "            </div>";
        html += "         </div>";
...
//        html += "    </div>";
        ...
        html += "                    </div>";
        html += "                    <div class=\"nickname_area\">";
        html += "                        <h4 class=\"nickname\">" + (isEmpty(name) ? "" : name) + "</h4>";
        //html += genderTag;
        // <!--<i class="web_wechat_women"></i>-->
        html += "                    </div>";
        html += "                    <p class=\"signature\" >" + (isEmpty(introduce) ? "" : introduce) + "</p>";
        html += "                    <div class=\"meta_area\">";
...
//            html = html + "    </div>";
            ...
            html = html + "    <div id=\"" + id + "\" >";
            html = html + "        <div class=\"box_hd\">";
            html = html + "            <div id=\"chatRoomMembersWrap\"></div>";
            html = html + "            <div class=\"title_wrap\">";
            html = html + "                <div class=\"title poi\" >";
            html = html + "                    <a id=\"" + nameId + "\" class=\"title_name\" >" + name + "</a>";
            html = html + "                    <i class=\"web_wechat_down_icon\" ></i>";
            html = html + "                </div>";
            html = html + "            </div>";
            html = html + "        </div>";

//            html = html + "        <div class=\"scroll-wrapper box_bd chat_bd scrollbar-dynamic\" style=\"position: absolute;\">";
//            html = html + "            <div class=\"box_bd chat_bd scrollbar-dynamic scroll-content scroll-scrolly_visible\"  style=\"margin-bottom: 0px; margin-right: 0px; height: 100%;\">";
//            html = html + "                <div id=\"" + messageListId + "\" class=\"scrollbar\">";
//            html = html + "                    <div class=\"bottom-placeholder \" style=\"height: 0px;\">";
//            html = html + "                    </div>";
//            html = html + "                </div>";
//            html = html + "            </div>";
//            html = html + "        </div>";
            html = html + "        <div id=\"" + messageListId + "\" class=\"box_bd\">";
            html = html + "        </div>";

            html = html + "        <div class=\"box_ft\" >";
//            html = html + "            <div class=\"toolbar\" id=\"tool_bar\">";
//            html = html + "                <a id=\"" + faceId + "\" class=\"web_wechat_face\" href=\"javascript:;\" title=\"表情\"></a>";
//            html = html + "                <a class=\"web_wechat_screencut\"  href=\"javascript:;\" title=\"截屏\"></a>";
//            html = html + "                <a class=\"web_wechat_pic js_fileupload  webuploader-container\"  title=\"图片和文件\">";
//            html = html + "                    <div class=\"webuploader-pick\"></div>";
//            html = html + "                    <div id=\"rt_rt_1c39vaq8v1jb81kac8rs1qeldfe1\" style=\"position: absolute; top: 0px; left: 0px; width: 30px; height: 30px; overflow: hidden; bottom: auto; right: auto;\">";
//            html = html + "                        <input type=\"file\" name=\"file\" class=\"webuploader-element-invisible\" >";
//            html = html + "                        <label style=\"opacity:0;width:100%;height:100%;display:block;cursor:pointer;background:rgb(255, 255, 255);\"></label>";
//            html = html + "                    </div>";
//            html = html + "                </a>";
//            html = html + "            </div>";
            html = html + "            <div class=\"content\" >";
            //html = html + "                <pre id=\"editArea\" class=\"flex edit_area\" contenteditable=\"true\" ></pre>";
            html = html + "                <textarea id=\"" + writeId + "\"  class=\"reply\"></textarea>";
            html = html + "                <span class=\"caret_pos_helper\" id=\"caretPosHelper\"></span>";
            html = html + "            </div>";
            html = html + "            <div class=\"action\">";
            html = html + "                <span class=\"desc\">按下Shift+Enter换行</span>";
            html = html + "                <a id=\"" + sendId + "\" class=\"btn btn_send\" href=\"javascript:;\" >发送</a>";
            html = html + "            </div>";
            html = html + "        </div>";
            html = html + "        <div class=\"catch-drop-area\"></div>";
            html = html + "    </div>";
    ...
    function setShowChatPaneEvent(itemId, chatPane) {
        ...
        //var messageListId = key + "_chat_message_list";
        //$("#"+messageListId).mCustomScrollbar({theme: "dark-3"});
    }
...
//            html = html + "    </div>";
            ...
            html = html + "        <div class=\"scroll-wrapper box_bd chat_bd scrollbar-dynamic\" style=\"position: absolute;\">";
            html = html + "            <div class=\"box_bd chat_bd scrollbar-dynamic scroll-content scroll-scrolly_visible\"  style=\"margin-bottom: 0px; margin-right: 0px; height: 100%;\">";
            html = html + "                <div id=\"" + messageListId + "\">";
            html = html + "                    <div class=\"bottom-placeholder \" style=\"height: 0px;\">";
            html = html + "                    </div>";
            html = html + "                </div>";
            html = html + "            </div>";
