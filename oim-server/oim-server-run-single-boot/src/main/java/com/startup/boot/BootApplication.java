...
import com.onlyxiahui.spring.context.annotation.AnnotationBeanFullNameGenerator;
import com.startup.BeanConfig;
import com.startup.DataSourceConfig;
import com.startup.HibernateConfig;
import com.startup.MyBatisConfig;
...
@ComponentScan(basePackages = { "com.im" }, nameGenerator = AnnotationBeanFullNameGenerator.class)
@EnableAspectJAutoProxy(proxyTargetClass = true)
@Import({ DataSourceConfig.class, HibernateConfig.class, BeanConfig.class, WebConfig.class ,MyBatisConfig.class}) // 导入其他配置
