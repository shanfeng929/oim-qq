...
public class GroupHeadDAO extends BaseDAO {
	...
	public GroupHead get(String groupId, String headId, String type) {
		...
		List<GroupHead> list = this.readDAO.queryPageList(sb.toString(), queryWrapper, GroupHead.class, null);
		GroupHead bean = null;
		if (null != list && !list.isEmpty()) {
			list.get(0);
		}
		// GroupHead bean = this.readDAO.queryUniqueResult(sb.toString(),
		// queryWrapper, GroupHead.class, null);
		return bean;
	}
