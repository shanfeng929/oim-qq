...
import com.onlyxiahui.query.hibernate.QueryOption;
import com.onlyxiahui.query.hibernate.QueryOptionType;
...
public class UserDAO extends BaseDAO {
	...
	public User getUserByAccount(String account) {
		...
		String sql = "select * from im_user where account=:account";
	...
	public User getUserByNumber(int number) {
		String sql = "select * from im_user where number=:number ";
	 ...
	 * @param avatar
	 * @return
	 * @createDate: 2018-04-22 12:54:53
	 * @update: XiaHui
	 * @updateDate: 2018-04-22 12:54:53
	 */
	public boolean updateAvatar(String id, String avatar) {
		StringBuilder sql = new StringBuilder();
		sql.append(" update im_user set `avatar`=:avatar ");
		sql.append(" where id=:id ");
		QueryWrapper queryWrapper = new QueryWrapper();
		queryWrapper.put("id", id);
