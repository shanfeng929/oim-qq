...
import com.startup.MessageQueueConfig;
...
@Import({ DataSourceConfig.class, HibernateConfig.class, MessageQueueConfig.class, BeanConfig.class, WebConfig.class }) // 导入其他配置
